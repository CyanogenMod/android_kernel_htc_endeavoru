...
/*/ 32k: receive buffer size /*/
/* change the buffer size from 8192 to 32k */
...
/* Special ioctl() upon a MUX device file for setting debug level */
#define TS0710MUX_IO_SET_DEBUG_LEVEL 0x54F2

/* Special ioctl() to force close MUX without negotiate on special case*/
