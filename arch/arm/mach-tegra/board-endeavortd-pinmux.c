/*
 * arch/arm/mach-tegra/board-endeavortd-pinmux.c
 *
...
static __initdata struct tegra_drive_pingroup_config endeavortd_drive_pinmux[] = {
...
static __initdata struct tegra_pingroup_config endeavortd_pinmux_common[] = {
    // For A project
    //Port A
    ...
    DEFAULT_PINMUX(LCD_PWR1,        RSVD,            PULL_UP,   NORMAL,     INPUT),                         //MDM_AP2BB_RST_PWRDWN#
    ...
    DEFAULT_PINMUX(LCD_PWR2,        DISPLAYA,         PULL_DOWN, NORMAL,     INPUT),                         //MDM_AP2BB_SLAVE_WAKEUP_1
...
//    DEFAULT_PINMUX(LCD_D0,          RSVD1,           PULL_DOWN, NORMAL,     OUTPUT),                        //MDM_SIM_INIT
    ...
    //Port J
    DEFAULT_PINMUX(GMI_CS0_N,       GMI,             PULL_DOWN, NORMAL,     INPUT),                         //MDM_BB2AP_HOST_WAKEUP
    ...
    DEFAULT_PINMUX(LCD_D20,         DISPLAYA,        PULL_DOWN, NORMAL,     INPUT),             //MDM_V_DCIN_MODEM_EN
    ...
    //Port N
    DEFAULT_PINMUX(DAP1_FS,         I2S0,            PULL_UP,    NORMAL,     INPUT),            //MDM_AP2BB_RST#
    DEFAULT_PINMUX(DAP1_DIN,        RSVD,            NORMAL,    NORMAL,     OUTPUT),              //AUDIO_MCLK_EN
    DEFAULT_PINMUX(DAP1_DOUT,       I2S0,            PULL_DOWN, NORMAL,     INPUT),             //MDM_BB_FATAL_INT
    DEFAULT_PINMUX(DAP1_SCLK,       I2S0,            PULL_DOWN,    NORMAL,     INPUT),              //MDM_AP2BB_PWRON
    ...
    DEFAULT_PINMUX(GPIO_PU5,        RSVD1,          PULL_DOWN,     NORMAL,     INPUT),             //PER_CAPSENSOR_INT_CPU
    DEFAULT_PINMUX(GPIO_PU6,        PWM3,            PULL_UP,   TRISTATE,     INPUT),               //DSP_AP_KPDPWR#

    //Port V
    DEFAULT_PINMUX(GPIO_PV0,        RSVD,            PULL_DOWN, NORMAL,     INPUT),             //MDM_BB2AP_SUSPEND_REQ
	...
	DEFAULT_PINMUX(SDMMC1_DAT3, 	SDMMC1, 		 NORMAL,   NORMAL,	   OUTPUT), 			//AUD_REMO_TX
	DEFAULT_PINMUX(SDMMC1_DAT2, 	SDMMC1, 		 NORMAL,   NORMAL,	   INPUT),			   //AUD_REMO_RX
...
static __initdata struct tegra_pingroup_config endeavortd_pinmux_EVM[] = {
    DEFAULT_PINMUX(LCD_D8,       RSVD,    PULL_DOWN,    NORMAL,    INPUT), // camera VCM power
	/* add SFIO config for specific board here */
};

static __initdata struct tegra_pingroup_config endeavortd_pinmux_EVT_XA[] = {
	/* add SFIO config for specific board here */
	DEFAULT_PINMUX(SDMMC3_DAT5,     PWM0,            NORMAL,    NORMAL,   OUTPUT), //HAPTIC_PWM_XA
};

static __initdata struct tegra_pingroup_config endeavortd_pinmux_EVT_XB[] = {
	/* add SFIO config for specific board here */
...
static __initdata struct tegra_pingroup_config endeavortd_pinmux_EVT_XC[] = {
	/* add SFIO config for specific board here */
	DEFAULT_PINMUX(GMI_AD8,         PWM0,            NORMAL,    NORMAL ,   OUTPUT), //HAPTIC_PWM_XC

	/* clone from endeavortd_pinmux_EVT_XB */
	DEFAULT_PINMUX(UART2_TXD,       SPI4,            NORMAL,    NORMAL,     INPUT),  //MAMCAM_SPI_CLK
	DEFAULT_PINMUX(UART2_RXD,       SPI4,            NORMAL,    NORMAL,     INPUT),     //MAMCAM_SPI_DO
	DEFAULT_PINMUX(UART2_RTS_N,       SPI4,            NORMAL,    NORMAL,     INPUT),     //MCAM_SPI_DI
	DEFAULT_PINMUX(UART2_CTS_N,       SPI4,            NORMAL,    NORMAL,     INPUT),     //MCAM_SPI_CS0
...
static __initdata struct tegra_pingroup_config endeavortd_pinmux_EVT_XD[] = {
	/* add SFIO config for specific board here */
	DEFAULT_PINMUX(GMI_AD8,         PWM0,            NORMAL,    NORMAL ,   OUTPUT), //HAPTIC_PWM_XC
	...
	DEFAULT_PINMUX(SPI1_MISO,       SPI1,            NORMAL,    NORMAL,     INPUT),     //SPI1_MOSI
	...
	DEFAULT_PINMUX(CLK3_REQ,       RSVD,            NORMAL,    TRISTATE,     INPUT),     //RAW_INTR1(input only)
	DEFAULT_PINMUX(ULPI_DATA4,     RSVD,           NORMAL,   NORMAL,     INPUT),   //BT UART CTS wake up source
	DEFAULT_PINMUX(SDMMC3_DAT4,    RSVD,            PULL_UP,   NORMAL,     INPUT), //PWR_CHG_INT
	
	/* PLSensor sdmmc_2v85_en */
	DEFAULT_PINMUX(LCD_D19,  RSVD, NORMAL, NORMAL, OUTPUT),

	/*SPRD SC8800G*/
	DEFAULT_PINMUX(LCD_D1,    DISPLAYA, NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_AP_RTS, TEGRA_GPIO_PE1
	DEFAULT_PINMUX(GPIO_PBB0, RSVD,     NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_AP_RDY, TEGRA_GPIO_PBB0
	DEFAULT_PINMUX(LCD_PWR1,  RSVD,     NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_AP_TO_MDM1, TEGRA_GPIO_PC1
	DEFAULT_PINMUX(LCD_D8,    RSVD,     NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_AP_TO_MDM2, TEGRA_GPIO_PF0
	DEFAULT_PINMUX(DAP4_FS,   I2S3,     NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_AP_SPI_RTY, TEGRA_GPIO_PP4
	DEFAULT_PINMUX(GPIO_PU1,  RSVD,     NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_AP_ALIVE, TEGRA_GPIO_PU1
	DEFAULT_PINMUX(LCD_PWR2,  DISPLAYA, NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_AP_RESEND, TEGRA_GPIO_PC6
	DEFAULT_PINMUX(GPIO_PU5,  RSVD1,    NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_MDM_RTS, TEGRA_GPIO_PU5
	DEFAULT_PINMUX(GPIO_PV0,  RSVD,     NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_MDM_RDY, TEGRA_GPIO_PV0
	DEFAULT_PINMUX(GPIO_PBB7, RSVD,     NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_MDM_TO_AP1, TEGRA_GPIO_PBB7
	DEFAULT_PINMUX(GMI_CS0_N, GMI,      NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_MDM_TO_AP2, TEGRA_GPIO_PJ0
	DEFAULT_PINMUX(DAP1_FS,   I2S0,     NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_MDM_RESET, TEGRA_GPIO_PN0
	DEFAULT_PINMUX(DAP4_DIN,  I2S3,     NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_MDM_RESEND, TEGRA_GPIO_PP5
	DEFAULT_PINMUX(GPIO_PU2,  RSVD,     NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_MDM_SPI_RTY, TEGRA_GPIO_PU2
	DEFAULT_PINMUX(DAP1_DOUT, I2S0,     NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_MDM_ALIVE, TEGRA_GPIO_PN2
	DEFAULT_PINMUX(LCD_SDIN,  DISPLAYA, NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_MDM_UART_SET, TEGRA_GPIO_PZ2
	DEFAULT_PINMUX(LCD_D20,   DISPLAYA, NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_MDM_POWER, TEGRA_GPIO_PM4
	DEFAULT_PINMUX(DAP3_DIN,  I2S2,     NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_MDM_NBOOT, TEGRA_GPIO_PP1
	DEFAULT_PINMUX(DAP1_SCLK, I2S0,     NORMAL,  NORMAL,   INPUT),//BB_PMIC_PWRON, TEGRA_GPIO_PN3
	DEFAULT_PINMUX(GMI_IORDY, RSVD1,    NORMAL,  TRISTATE, INPUT),//SPRD_SC800x_GPIO_SIM_DOOR, TEGRA_GPIO_PI5
	DEFAULT_PINMUX(GMI_A17,   UARTD,    NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_UART4_RXD, TEGRA_GPIO_PB0
	DEFAULT_PINMUX(GMI_A18,   UARTD,    NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_UART4_CTS, TEGRA_GPIO_PB1
	DEFAULT_PINMUX(GMI_A16,   UARTD,    NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_UART4_TXD, TEGRA_GPIO_PJ7
	DEFAULT_PINMUX(GMI_A19,   UARTD,    NORMAL,  NORMAL,   INPUT),//SPRD_SC800x_GPIO_UART4_RTS,TEGRA_GPIO_PK7

};

static __initdata struct tegra_pingroup_config endeavortd_pinmux_EVT_XE[] = {
	/* add SFIO config for specific board here */
	DEFAULT_PINMUX(GMI_AD8,         PWM0,            NORMAL,    NORMAL ,   OUTPUT), //HAPTIC_PWM_XC
	DEFAULT_PINMUX(UART2_TXD,       SPI4,            NORMAL,    NORMAL,     INPUT),  //MAMCAM_SPI_CLK
	DEFAULT_PINMUX(UART2_RXD,       SPI4,            NORMAL,    NORMAL,     INPUT),     //MAMCAM_SPI_DO
...
int __init endeavortd_pinmux_init(void)
{
	int board_id;
	tegra_pinmux_config_table(endeavortd_pinmux_common, ARRAY_SIZE(endeavortd_pinmux_common));
	tegra_drive_pinmux_config_table(endeavortd_drive_pinmux,
					ARRAY_SIZE(endeavortd_drive_pinmux));

	board_id = htc_get_pcbid_info();
	if (board_id == PROJECT_PHASE_EVM) // EVM
		tegra_pinmux_config_table(endeavortd_pinmux_EVM,
			ARRAY_SIZE(endeavortd_pinmux_EVM));
	else if (board_id == PROJECT_PHASE_XA) // EVT XA
		tegra_pinmux_config_table(endeavortd_pinmux_EVT_XA,
			ARRAY_SIZE(endeavortd_pinmux_EVT_XA));
	else if (board_id == PROJECT_PHASE_XB) // EVT XB
		tegra_pinmux_config_table(endeavortd_pinmux_EVT_XB,
			ARRAY_SIZE(endeavortd_pinmux_EVT_XB));
	else if (board_id == PROJECT_PHASE_XC) // XC
		tegra_pinmux_config_table(endeavortd_pinmux_EVT_XC,
			ARRAY_SIZE(endeavortd_pinmux_EVT_XC));
	else if (board_id == PROJECT_PHASE_XD) // XD
		tegra_pinmux_config_table(endeavortd_pinmux_EVT_XD,
			ARRAY_SIZE(endeavortd_pinmux_EVT_XD));
	else // latest project phase
		tegra_pinmux_config_table(endeavortd_pinmux_EVT_XE,
			ARRAY_SIZE(endeavortd_pinmux_EVT_XE));

	return 0;
}

const struct tegra_pingroup_config endeavor_ste6718_pinmux[] = {
	/* PV0 is used for BP_INT_AP, need to be pull'd down */
	DEFAULT_PINMUX(GPIO_PV0, RSVD1, PULL_DOWN, NORMAL, INPUT),
	/* PU2 is used for BP_STATUS_AP, need to be pull'd down */
	DEFAULT_PINMUX(GPIO_PU2, RSVD, PULL_DOWN, NORMAL, INPUT),
	/* PN2 is used for BP_RSTEXT, need to be pull'd down */
	DEFAULT_PINMUX(DAP1_DOUT, RSVD1, PULL_DOWN, NORMAL, INPUT),
	/* null termination */
	{0}
};
